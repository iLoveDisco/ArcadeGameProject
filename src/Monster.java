...
public abstract class Monster extends Character {
	...
	/**
	 * Constructs the monster, sets it's speed and starting position
	 */
	...
	/**
	 * Increases the size of the monster
	 */
	public void inflate() {
	...
	/**
	 * Decreases the size of the monster
	 */
	public void deflate() {
		this.height -= .1;
		this.width -= .1;
	...
	/**
	 * Checks whether the future position is a legal move.
	 *  - Accounts for future collisions.
	 */
	@Override
	...
	/**
	 * Updates the current position of the monster.
	 */
	@Override
	...
	/**
	 * Updates the Monster's state in ghost mode
	 *
	 */
	...
	/**
	 * Turns the monster into a ghost.
	 */
	...
	/**
	 * Lets the monster know when it can "unghost"
	 */
	...
	/**
	 * Constantly updates the monster.
	 */
	@Override
	...
	void collideWithRock(Rock thisRock) {
		if (thisRock.rect.intersects(this.hitBox) && !this.isGhost && !hasBeenInflated) {
			this.shouldRemove = true;
		}
