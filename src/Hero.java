...
public class Hero extends Character {
	...
	//Creates the hero with a rectangle body.
	...
	//Checks whether the future move collides with a Rock.
	@Override
	...
	//Turns the Hero into a dead state
	public void die() {
		this.dead = true;
	}
	
	//Turns on the Hero's pump
	public void pump() {
		// get a rectangle to show up to represent the pump shooting
		this.pumpOut = true;
	}
	
	//Renders the image and updates the pump
	@Override
	...
	//Animates the pump. Uses a set of booleans to determine the Hero's direction.
	...
	void collideWithOneUp(OneUp oneUp) {
		if(this.rect.intersects(oneUp.rect)) {
			oneUp.shouldRemove = true;
		}
	}
	//-----------------\\
}
